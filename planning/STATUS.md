# PRODUCTION STATUS — THE HARU NATSUKI SAGA

*The production line's single source of truth. Update this file, never rely on chat memory. Last updated: 2026-08-28.*
...
3. **One chapter per chat** (maximum 2–3 if they're light). Chat history is disposable; the files are the memory.
