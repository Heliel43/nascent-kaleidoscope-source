# STYLE CODEX — the voice, mined from the bank
...
10. **End every chapter on an obligation, not a punchline.** Cliffhangers in this fic are *responsibilities arriving* (a phone number on a flyer; a Monday; a name on a list), not explosions. (Sneaking's chapter-end tic — "Pyrrha was on her way to face the fire lady. Prior to which..." — is the exact rhythm: the clock, then the sentence.)

## Cards & box formatting (the ONLY UI grammar)
...
## Length, pacing, grammar
- Chapters 8k–15k (arc 1 beats list per-chapter cores; if a chapter wants 18k it becomes two chapters — QQ serials earn their chapter counts, they don't pad them).
- Timeline discipline: every chapter gets a date header (`September 15, 2010` — Worm-style, no chapter epigraph quotes in arc 1; save epigraphs for interludes, arc 2+).
- Grammar: first person past; contractions always; "was like" *never*; "kind of" allowed once per chapter (he's a teenager, not a writer); the Oxford comma stays (the brief's own style: exact lists).
- Slang ceiling: 2010 internet, not 2026 internet — he says "awesome" out loud and cringes; "based" does not exist yet.
- The **fandom-words ban**: "kino," "pov," "OP," "canon event," "NPC," "main character energy" — none; his meta-knowledge expresses as *wrong facts about people*, never as memetics.
- Recurring micro-motifs (seeded, do not over-rhyme): the pack's weight; counting doors; the headlamp click; "someone has to help" as *action*, quoted only by *other* characters; November weather arriving early; the electricity bill on the counter.

## Reference quotes (from the bank — for calibration only; mine the *moves*, not the words)
